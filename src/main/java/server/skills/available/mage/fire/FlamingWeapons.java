...
public class FlamingWeapons extends ChannelledSkill {
    ...
    public FlamingWeapons() {
        super(
                "Flaming weapons",
                "Primary and secondary imbue. Granting fire damage and burn effect to all your"
                        + " attacks",
    ...
    public void endSkill(CombatData combatData, SkillTarget skillTarget) {
        ...
        Map<String, AttributeEffects> primary =
                Map.of(
        ...
        Status primaryImbue =
                new Imbue(
                        ...
                        StatsTypes.PRIMARY_IMBUE,
                        primary,
                        2,
                        this.getName());

        Map<String, AttributeEffects> secondary =
                Map.of(
                        StatsTypes.PRIMARY_IMBUE.getType(),
                        new AttributeEffects(DamageTypes.FIRE.getType(), 40.0, 0.0));

        Status secondaryImbue =
                new Imbue(
                        duration,
                        skillTarget.getCasterId(),
                        StatsTypes.SECONDARY_IMBUE,
                        secondary,
                        2,
                        this.getName());

...
@Slf4j
@Serdeable
@JsonTypeName("Spellweaver")
@EqualsAndHashCode(callSuper = false)
public class Spellweaver extends Talent {

    public Spellweaver() {
        this.name = "Spellweaver";
        this.description = "Increases max mana by 3% per rank (max 5 ranks)";
        this.levels = 5;
        ...
        AttributeEffects attributeEffect =
                new AttributeEffects(StatsTypes.MAX_MP.getType(), 0.03, null);

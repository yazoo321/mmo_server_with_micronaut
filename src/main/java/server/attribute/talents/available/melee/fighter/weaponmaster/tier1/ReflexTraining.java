...
@Slf4j
@Serdeable
@JsonTypeName("Reflex training")
@EqualsAndHashCode(callSuper = false)
public class ReflexTraining extends Talent {

    public ReflexTraining() {
        this.name = "Reflex training";
        this.description = "Increases your chance to dodge an attack";
        this.levels = 5;
        ...
        AttributeEffects attributeEffect =
                new AttributeEffects(StatsTypes.DODGE.getType(), 2.0, null);

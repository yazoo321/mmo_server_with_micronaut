...
public class MonsterAttributeService {
    ...
    @Inject MonsterAttributeRepository monsterAttributeRepository;

    public Single<MonsterAttributes> createMobAttributes(
            String mobInstanceId, Map<String, Integer> attributes) {
        AttributeService.validateAttributes(attributes);
        MonsterAttributes mobAttributes =
                MonsterAttributes.builder()

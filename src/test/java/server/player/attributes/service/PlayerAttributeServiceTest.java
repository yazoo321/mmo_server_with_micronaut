...
public class PlayerAttributeServiceTest {
    ...
    void testAddingAttributeWillAddItToBaseAndCount(String attributeAdded) {
        ...
        NumTag baseTag = PlayerAttributeService.findTag(playerAttributes.getBaseAttributes(),
                attributeAdded);
        NumTag addedTag = PlayerAttributeService.findTag(playerAttributes.getAttributesAdded(),
                attributeAdded);
        NumTag currentTag = PlayerAttributeService.findTag(playerAttributes.getCurrentAttributes(),
                attributeAdded);
        ...
        NumTag actualBase = PlayerAttributeService.findTag(actualAttributes.getBaseAttributes(),
                attributeAdded);
        NumTag actualAdded = PlayerAttributeService.findTag(actualAttributes.getAttributesAdded(),
                attributeAdded);
        NumTag actualCurrent = PlayerAttributeService.findTag(actualAttributes.getCurrentAttributes(),
                attributeAdded);
    ...
    void testModifyCurrentAttributesWillChangeThemAsExpected(String attributeAdded, Integer amount) {
        // given
        PlayerAttributes playerAttributes = attributeService.createBaseAttributes(CHARACTER_NAME);
